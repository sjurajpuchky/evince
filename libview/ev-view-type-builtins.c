...
GType
ev_job_thumbnail_format_get_type (void)
{
  static volatile gsize g_define_type_id__volatile = 0;
 
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      { EV_JOB_THUMBNAIL_PIXBUF, "EV_JOB_THUMBNAIL_PIXBUF", "pixbuf" },
      { EV_JOB_THUMBNAIL_SURFACE, "EV_JOB_THUMBNAIL_SURFACE", "surface" },
      { 0, NULL, NULL }
    };
    GType g_define_type_id = \
       g_enum_register_static (g_intern_static_string ("EvJobThumbnailFormat"), values);
